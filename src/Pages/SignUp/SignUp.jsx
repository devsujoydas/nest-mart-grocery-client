          ...
          >
            <div className='space-y-4 md:text-sm text-xs'>
              ...
              <div className='md:mt-8 mt-3 md:block flex justify-center items-center'>
                <button className='px-8 md:w-fit w-full md:py-4 py-3 bg-emerald-500 rounded-lg font-bold text-white hover:bg-emerald-400 duration-500 cursor-pointer active:scale-95 transition-all '>
                  Submit & Register
                </button>
              </div>
            </div>
