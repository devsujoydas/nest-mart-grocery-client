...
const ProductDetails = () => {
  ...
  const { Sale, description, type, mfg, life, sku, tags, stock, vendor } = productDetails;
  ...
  return (
    <div className='md:mx-10 2xl:mx-0 mx-3'>
      ...
      <div className=' grid md:grid-cols-9 gap-5 rounded-md  max-w-screen-2xl mx-auto md:my-10 my-5'>
          ...
          <div className='grid md:grid-cols-2 gap-3 md:gap-10'>
            ...
            <div className='flex flex-col  gap-3 md:gap-5'>
              ...
              <div className=' flex gap-3 cursor-pointer '>
                <div onMouseEnter={() => setImgBanner(img1)} className='border  hover:border-emerald-300 duration-500 transition-all border-zinc-200 rounded-lg overflow-hidden'><img className='w-26' src={img1} alt="" /></div>
                <div onMouseEnter={() => setImgBanner(img2)} className='border hover:border-emerald-300 duration-500 transition-all border-zinc-200 rounded-lg overflow-hidden'><img className='w-26' src={img2} alt="" /></div>
              </div>
            </div>
            {/* Details Container */}
        ...
        <div className='md:col-span-2  grid gap-5 h-fit'>
          <Category />
          <FillByPrice />
