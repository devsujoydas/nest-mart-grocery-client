        ...
        <div>
            ...
            <div className='flex justify-center items-center p-30'>
                <div className='flex flex-col items-center gap-5'>
                    ...
                    <button onClick={() => navigate(-1)}  className='px-8 py-3 cursor-pointer  bg-emerald-500 hover:bg-yellow-400 text-sm text-white hover:text-black font-family-primary font-bold rounded-md active:scale-95   duration-300 transition-all'>Back to Home</button>
                </div>
            </div>
