...
const Account = () => {
  const accBtnStyle = 'border group border-zinc-200 cursor-pointer hover:border-zinc-300 rounded-lg w-full font-bold text-zinc-700 py-3.5 flex items-center gap-2 px-5'
  ...
  return (
    <div>
      ...
      <div className=' max-w-screen-2xl mt-10 2xl:mx-auto md:mx-10 mx-3 grid md:grid-cols-4 gap-14'>
        {/* left btns */}
        <div className='md:col-span-1 font-family-primary'>
        <div className=' grid gap-3  font-family-primary'>
