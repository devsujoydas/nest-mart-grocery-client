        ...
        <div className='font-family-secondary'>
            ...
            <div className='max-w-7xl mx-auto md:py-14 py-5 md:space-y-14 space-y-5 '>
                ...
                >
                    ...
                    <div className='grid md:grid-cols-2 lg:grid-cols-3 md:gap-5 gap-3'>
            ...
            >
                <div className='max-w-screen-2xl mx-auto bg-center md:bg-contain bg-cover bg-no-repeat  rounded-xl overflow-hidden' style={{ backgroundImage: `url("https://nest-frontend-v6.vercel.app/assets/imgs/page/about-9.png")` }}>

                    <div className='w-full h-full bg-[#12522f8f] '>
                        <div className='w-full h-full bg-[#68817496] md:py-30 py-10 flex justify-center items-center'>
                            <div className='grid  grid-cols-2 gap-y-10 md:p-0 p-5 lg:grid-cols-5 w-full'>

                                <div className='font-bold font-family-primary text-white text-center'>
                                    <h1 className='md:text-7xl text-3xl'>12+</h1>
                                    <p className='md:text-xl text-sm'>Glorious years</p>
                                </div>

                                <div className='font-bold font-family-primary text-white text-center'>
                                    <h1 className='md:text-7xl text-3xl'>36+</h1>
                                    <p className='md:text-xl text-sm'>Happy Clients</p>
                                </div>

                                <div className='font-bold font-family-primary text-white text-center'>
                                    <h1 className='md:text-7xl text-3xl'>57+</h1>
                                    <p className='md:text-xl text-sm'>Projects complete</p>
                                </div>

                                <div className='font-bold font-family-primary text-white text-center'>
                                    <h1 className='md:text-7xl text-3xl'>24+</h1>
                                    <p className='md:text-xl text-sm'>Team advisor</p>
                                </div>

                                <div className='font-bold lg:block hidden font-family-primary text-white text-center'>
                                    <h1 className='md:text-7xl text-3xl'>23+</h1>
            ...
            >
                <div className='max-w-7xl mx-auto lg:py-10 md:py-0 py-8'>
                    ...
                    <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-10 mt-5 md:mt-10 '>
