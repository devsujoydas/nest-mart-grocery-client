...
const StoreCard = ({store}) => {
    return (
        <div className='border border-zinc-200 rounded-xl p-3 md:p-5 font-family-primary'>
            ...
            <Link to={`/stores/${store?.name}`} className="bg-emerald-500 w-fit hover:bg-orange-400 hover:px-5 active:scale-95 transition-all px-2 md:px-4 py-2 text-xs md:text-sm rounded-sm flex items-center gap-1 text-white font-semibold cursor-pointer mt-5 duration-500">
