        ...
        <div className="text-left">
            <div className="border border-zinc-200 relative overflow-hidden md:p-4 p-2 lg:p-6 md:rounded-2xl rounded-md  ">
                ...
                <div className="flex flex-col mb-1">
                    ...
                    <a href="#" className="text-left font-bold my-1 leading-none hover:text-emerald-500 transition-colors md:text-[16px] text-sm">Talenti
                ...
                <div className="grid gap-2">
                    ...
                    <h1 className="text-emerald-500 font-semibold md:text-lg text-sm">$24.49</h1>
                </div>
                <div className=" mt-1"> 
